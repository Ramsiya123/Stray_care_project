...
include 'connect.php';
if(isset($_POST['add'])) {
    if (isset($_POST['name']) && isset($_POST['type']) && isset($_POST['email']) && isset($_POST['loc'])&& isset($_POST['phone']) && isset($_POST['code']) && isset($_POST['pass'])) {
        $name = $_POST['name'];
        $lsgtype = $_POST['type'];
        $email = $_POST['email'];
        $loc = $_POST['loc'];
        ...
        if ($con->connect_error) {
            ...
            $sql2 = mysqli_query($con, "INSERT INTO local_govt_tb(lsg_name,type,location,ph_no,email, log_id) values ('$name','$lsgtype','$loc','$phone','$email','$user_id')");
            if ($sql1 && $sql2) {
...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i>Add LSG Details</h1>
                <!-- <p>Sample forms</p> -->
            </div>
                    ...
                    <div class="tile-body">
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Institution Type" name="type"pattern=".{4,}"  required>
                            </div>
                            <div class="form-group">
