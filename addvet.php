...
include 'connect.php';
if(isset($_POST['add'])) {
    if (isset($_POST['name']) && isset($_POST['loc'])&& isset($_POST['email']) && isset($_POST['phone']) && isset($_POST['code']) && isset($_POST['pass'])) {
        $name = $_POST['name'];
        $loc = $_POST['loc'];
        $email = $_POST['email'];
        $code = $_POST['code'];
        ...
        if ($con->connect_error) {
            ...
            $sql2 = mysqli_query($con, "INSERT INTO veterinary_tb(center,location,ph_no,email, login_id) values ('$name','$loc','$phone','$email','$user_id')");
            if ($sql1 && $sql2) {
...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i>Add Veterinary Details</h1>
                <!-- <p>Sample forms</p> -->
            </div>
                    ...
                    <div class="tile-body">
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Clinic/Hospital Name" name="name" pattern=".{4,}" required>
                            </div>
                            <div class="form-group">
