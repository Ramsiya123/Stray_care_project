<?php
include 'connect.php';
// $sql = mysqli_query($con, "SELECT * from station inner join login on station.login_id=login.log_id where status='1'");
$sql = mysqli_query($con, "SELECT * from local_govt_tb inner join authority_login_tb on local_govt_tb.log_id=authority_login_tb.log_id;");
?>
...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
        <div class="app-title">
          <div>
            <h1><i class="fa fa-th-list"></i>Authorities</h1>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="tile">
              <h3 class="tile-title">Local Self Government</h3>
              <div class="tile-title-w-btn">
                <h3 class="title"></h3>
                <p><a class="btn btn-primary icon-btn" href="addlsg.php"><i class="fa fa-plus"></i>Add </a></p>
              </div>         
                    ...
                    <?php
                        ...
                        if($sql->num_rows>0){
                          ...
                          while($row=mysqli_fetch_array($sql)){
                              ?>
                  <tr>
                  <td><?php echo '#'.$row['lsg_id']; ?></td>
                 <td><?php echo $row['lsg_name'];?></td>
                 ...
                 <td><?php echo $row['ph_no'];?></td>
                  ...
                  <td>
                  <a href="editlsg.php?id=<?php echo $row['log_id']?>"class="btn btn-primary" ><i class="fa fa-lg fa-edit"></i></a>
                 <a href="deletelsg.php?id=<?php echo $row['log_id']?>"class="btn btn-primary" > <i class="fa fa-lg fa-trash" ></i> </a>
