  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="tile">
              <h3 class="tile-title">Veterinary</h3>
              <div class="tile-title-w-btn">
                <h3 class="title"></h3>
                <p><a class="btn btn-primary icon-btn" href="addvet.php"><i class="fa fa-plus"></i> Add </a></p>
              </div>         
                 ...
                 <td><?php echo $row['ph_no'];?></td>
                  ...
                  <td>
                  <a href="editvet.php?id=<?php echo $row['log_id']?>"class="btn btn-primary" ><i class="fa fa-lg fa-edit"></i></a>
                 <a href="deletevet.php?id=<?php echo $row['log_id']?>"class="btn btn-primary" > <i class="fa fa-lg fa-trash" ></i> </a>
