...
include 'connect.php';
    ...
    $user_id=$_GET['id'];
    $sql=mysqli_query($con,"SELECT * from local_govt_tb inner join authority_login_tb on local_govt_tb.log_id=authority_login_tb.log_id where local_govt_tb.log_id='$user_id'");
...
if(isset($_POST['update'])) {
        ...
        if ($con->connect_error) {
            ...
            $sql1 = mysqli_query($con, "UPDATE authority_login_tb set code='$code',password='$pass' where log_id='$user_id'   ");
            // $user_id = mysqli_insert_id($con);
            $sql2 = mysqli_query($con, "UPDATE  local_govt_tb set lsg_name='$name',type='$lsgtype',location='$loc', ph_no='$phone', email='$email' where log_id='$user_id'");
            if ($sql1 && $sql2) {
                echo "Updated successfully";
                echo"<script>alert('Updated Successfully');</script>";
                echo "<script>window.location.href='lsg.php'; </script>";
            } else {
                
                echo "Fail to update !!";
                echo"<script>alert('Failed to  Update  !');</script>";

                header("location:lsg.php");
            }
    }
}
?>
...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i>Edit Details</h1>
                <!-- <p>Sample forms</p> -->
            </div>
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php"><i class="fa fa-home fa-lg"></a></i></li>
                <li class="breadcrumb-item">Local Self Government</li>
                ...
                <div class="tile">
                    ...
                    <form action="" method="POST">
                            <div class="form-group">
                                <label class="control-label">LSG Name</label>
                                <input class="form-control" type="text" placeholder="Name " name="name" value="<?php echo $row['lsg_name'];?>">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Type</label>
                                <input class="form-control" type="text" placeholder="Institution Type" name="type"pattern=".{4,}"  value="<?php echo $row['type'];?>">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Location</label>
                                <input class="form-control" type="text" placeholder="Location" name="loc" value="<?php echo $row['location'];?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Phone" name="phone"pattern="[6789][0-9]{9}" value="<?php echo $row['ph_no'];?>">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Code</label>
                                <input class="form-control" type="text" placeholder="Code" name="code"pattern=".{8}" value="<?php echo $row['code'];?>">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Password</label>
                                <input class="form-control" type="text" placeholder="Password" name="pass"pattern=".{8,}"  value="<?php echo $row['password'];?>">
                            </div>
                            <div class="tile-footer">
                        <button class="btn btn-primary" name="update"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update</button>
                        <!-- <a class="btn btn-primary" href="index.php"><i class="fa fa-fw fa-lg fa-check-circle"></i>sign up</a> -->

                        &nbsp;&nbsp;&nbsp;
                        <a class="btn btn-secondary" href="lsg.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                    </div>
