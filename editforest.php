...
include 'connect.php';
    ...
    $user_id=$_GET['id'];
    $sql=mysqli_query($con,"SELECT * from forest_tb inner join authority_login_tb on forest_tb.login_id=authority_login_tb.log_id where forest_tb.login_id='$user_id'");
...
if(isset($_POST['update'])) {
    ...
    $pass = $_POST['pass'];
        ...
        if ($con->connect_error) {
            ...
            $sql2 = mysqli_query($con, "UPDATE  forest_tb set location='$loc', ph_no='$phone', email='$email' where login_id='$user_id'");
            if ($sql1 && $sql2) {
