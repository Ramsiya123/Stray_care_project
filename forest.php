...
$sql = mysqli_query($con, "SELECT * from forest_tb inner join authority_login_tb on forest_tb.login_id=authority_login_tb.log_id;");
?>
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="tile">
              <h3 class="tile-title">Forest</h3>
              <div class="tile-title-w-btn">
                <h3 class="title"></h3>
                <p><a class="btn btn-primary icon-btn" href="addforest.php"><i class="fa fa-plus"></i> Add </a></p>
              </div>         
                 ...
                 <td><?php echo $row['ph_no'];?></td>
                  ...
                  <td>
                  <a href="editforest.php?id=<?php echo $row['log_id']?>"class="btn btn-primary" ><i class="fa fa-lg fa-edit"></i></a>
                 <a href="deleteforest.php?id=<?php echo $row['log_id']?>"class="btn btn-primary" > <i class="fa fa-lg fa-trash" ></i> </a>
