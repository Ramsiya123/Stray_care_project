...
include 'connect.php';
    ...
    $user_id=$_GET['id'];
    $sql=mysqli_query($con,"SELECT * from veterinary_tb inner join authority_login_tb on veterinary_tb.login_id=authority_login_tb.log_id");
...
if(isset($_POST['update'])) {
    ...
    $pass = $_POST['pass'];
        ...
        if ($con->connect_error) {
            ...
            $sql2 = mysqli_query($con, "UPDATE  veterinary_tb set center='$name',location='$loc', ph_no='$phone', email='$email' where login_id='$user_id'");
            if ($sql1 && $sql2) {
                echo "Updated successfully";
                echo"<script>alert('Updated Successfully');</script>";
                echo "<script>window.location.href='vet.php'; </script>";
            } else {
    ...
    <main class="app-content">
        <div class="app-title">
            ...
            <ul class="app-breadcrumb breadcrumb">
                ...
                <li class="breadcrumb-item">Veterinary</li>
                ...
                <div class="tile">
                    ...
                    <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Clinic/Hospital Name" name="name"pattern=".{4,}" value="<?php echo $row['center'];?>">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Location</label>
                                <input class="form-control" type="text" placeholder="Location" name="loc"pattern=".{4,}" value="<?php echo $row['location'];?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="phone" placeholder="Phone"  name="phone" pattern="[6789][0-9]{9}"value="<?php echo $row['ph_no'];?>">
                            </div>
                            <div class="form-group">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <a class="btn btn-secondary" href="vet.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                    </div>
