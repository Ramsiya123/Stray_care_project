<?php
include 'connect.php';
$sql = mysqli_query($con, "SELECT * from registration_tb inner join user_login on registration_tb.log_id=user_login.log_id");
?>
            ...
            <div class="tile">
              ...
              <div class="tile-title-w-btn">
                ...
                <!-- <p><a class="btn btn-primary icon-btn" href="adduser.php"><i class="fa fa-plus"></i>Add User	</a></p> -->
                 ...
                 <a href="deleteUser.php?id=<?php echo $row['log_id']?>"class="btn btn-primary" > <i class="fa fa-lg fa-trash" ></i> </a>
