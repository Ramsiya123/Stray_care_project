...
include 'connect.php';
    ...
    $user_id=$_GET['id'];
    $sql=mysqli_query($con,"SELECT * from police_tb inner join authority_login_tb on police_tb.login_id=authority_login_tb.log_id where police_tb.login_id='$user_id'");
...
if(isset($_POST['update'])) {
    ...
    $pass = $_POST['pass'];
        ...
        if ($con->connect_error) {
            ...
            $sql2 = mysqli_query($con, "UPDATE  police_tb set station='$name', ph_no='$phone', email='$email' where login_id='$user_id'");
            if ($sql1 && $sql2) {
                    ...
                    <div class="tile-body">
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Station At" name="name"pattern=".{4,}"  value="<?php echo $row['station'];?>">
                            </div>
                            <div class="form-group">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <a class="btn btn-secondary" href="police.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                    </div>
