...
include 'connect.php';
    ...
    $sql=mysqli_query($con,"SELECT * from office_tb inner join authority_login_tb on office_tb.login_id=authority_login_tb.log_id where office_tb.login_id='$user_id'");
...
if(isset($_POST['update'])) {
    ...
    $pass = $_POST['pass'];
        ...
        if ($con->connect_error) {
            ...
            $sql2 = mysqli_query($con, "UPDATE  office_tb set location='$loc', ph_no='$phone', email='$email' where login_id='$user_id'");
            if ($sql1 && $sql2) {
            ...
            <div class="col-md-6">
                <div class="tile">
                    ...
                    <form action="" method="POST">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <a class="btn btn-secondary" href="office.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                    </div>
