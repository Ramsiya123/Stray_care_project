<?php
include 'connect.php';
$sql = mysqli_query($con, "SELECT * FROM `missing_tb`  WHERE status='missing';");
?>
...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
        <div class="app-title">
          <div>
            <h1><i class="fa fa-th-list"></i>Missing Pets</h1>
                    ...
                    <?php
                        ...
                        if($sql->num_rows>0){
                          ...
                          while($row=mysqli_fetch_array($sql)){
                              ?>
                  <tr>
                  <td><?php echo $row['missing_id']; ?></td>
                  <td><?php echo $row['animal_type']; ?></td>
                 <td><?php echo $row['name'];?></td>                
                  <td><?php echo $row['breed']?></td>
                  <td><?php echo $row['color']?></td>
                  <td><?php echo $row['health_cond']?></td>
                  <td><?php echo $row['lastseen_on']?></td>
                  <td><?php echo $row['lastseen_at']?></td>
