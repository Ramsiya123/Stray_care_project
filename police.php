...
$sql = mysqli_query($con, "SELECT * from police_tb inner join authority_login_tb on police_tb.login_id=authority_login_tb.log_id");
?>
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="tile">
              <h3 class="tile-title">Police</h3>
              <div class="tile-title-w-btn">
                <h3 class="title"></h3>
                <p><a class="btn btn-primary icon-btn" href="addpolice.php"><i class="fa fa-plus"></i> Add </a></p>
              </div>         
                 ...
                 <td><?php echo $row['ph_no'];?></td>
                  ...
                  <td>
                  <a href="editpolice.php?id=<?php echo $row['log_id']?>"class="btn btn-primary" ><i class="fa fa-lg fa-edit"></i></a>
                 <a href="deletepolice.php?id=<?php echo $row['log_id']?>"class="btn btn-primary" > <i class="fa fa-lg fa-trash" ></i> </a>
