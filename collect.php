<?php
include 'connect.php';
$sql = mysqli_query($con, "SELECT * FROM collected_tb inner join animal_tb on collected_tb.animal_id=animal_tb.animal_id INNER JOIN office_tb on collected_tb.office_id=office_tb.login_id;");
?>
...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
        <div class="app-title">
          <div>
            <h1><i class="fa fa-th-list"></i>Collected Animals</h1>
